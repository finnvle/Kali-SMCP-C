...
def parse_args():
    ...
    parser.add_argument("--server", type=str, default=settings.MCP_SERVER_URL, 
                      help=f"Kali API server URL (default: {settings.MCP_SERVER_URL})")
    parser.add_argument("--timeout", type=int, default=settings.REQUEST_TIMEOUT,
                      help=f"Request timeout in seconds (default: {settings.REQUEST_TIMEOUT})")
